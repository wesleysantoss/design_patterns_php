...
require_once "EstadoOrcamento.php";
require_once "Aprovado.class.php";
require_once "EmAprovacao.class.php";
require_once "Reprovado.class.php";
require_once "Finalizado.class.php";
...
// Desconto aplicado de acordo com o estado do orçamento.
echo "<br><br> Descontos aplicado (De acordo com o estado): <br>";
$Orcamento->aplicaDesconto();
echo "Valor do orçamento, apos o desconto R$ {$Orcamento->getValor()}";
?>